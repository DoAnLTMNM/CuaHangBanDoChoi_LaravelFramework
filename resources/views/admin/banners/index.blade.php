            ...
            <form id="editBannerForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <img id="edit_banner_preview" src="#" style="display:none; width:200px; margin-top:10px;">
                    </div>
                    ...
                    <!-- Hidden input gửi 0 nếu không check -->
                    <input type="hidden" name="is_active" value="0">
                    <div class="form-check">
                        <input type="checkbox" name="is_active" class="form-check-input" id="edit_banner_is_active" value="1">
