            ...
            <div class="flex-grow-1">
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="input-group input-group-sm" style="width: 110px;">
                        <button type="button" class="btn btn-outline-secondary quantity-btn btn-minus" data-id="{{ $cartId }}">−</button>
                        <input type="number" value="{{ $quantity }}" min="1"
                            class="form-control text-center quantity-input"
                            data-id="{{ $cartId }}">
                        <button type="button" class="btn btn-outline-secondary quantity-btn btn-plus" data-id="{{ $cartId }}">+</button>
                    </div>
                </div>
