            ...
            <div class="row" id="cart-items-container">
                ...
                <div class="cart-items-list col-md-8">
                    ...
                    @foreach ($cartItems as $item)
                        ...
                        <div class="cart-item border-bottom mb-3" data-id="{{ $cartId }}"
                ...
                <div class="col-md-4">
                    <div class="cart-total-box p-4 border rounded bg-white shadow-sm">
                        ...
                        <a href="{{ route('checkout.index') }}"
                            class="btn btn-danger w-100 py-2 fw-bold text-uppercase">Thanh toán</a>

                    </div>
                </div>
            </div>

            {{-- <a href="{{ route(' ') }}" class="btn btn-secondary mt-3">Tiếp tục mua hàng</a> --}}
        @else
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function recalcTotal() {
                ...
                document.querySelectorAll('.cart-item').forEach(item => {
                    ...
                    item.querySelector('.subtotal div:last-child').textContent = subtotal.toLocaleString(
                        'vi-VN') + '₫';
                    total += subtotal;
                });
