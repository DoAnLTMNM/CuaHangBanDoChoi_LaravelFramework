        ...
        <div class="w-50 mt-5" style="max-width: 600px;">
            ...
            <ul class="nav nav-tabs nav-fill" id="authTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ !$isRegisterError ? 'active' : '' }}" id="login-tab" data-bs-toggle="tab"
                        data-bs-target="#login-pane" type="button" role="tab" aria-controls="login-pane"
                        aria-selected="{{ !$isRegisterError ? 'true' : 'false' }}">
                        Đăng nhập
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ $isRegisterError ? 'active' : '' }}" id="register-tab" data-bs-toggle="tab"
            ...
            <div class="tab-content" id="authTabsContent">
                ...
                <div class="tab-pane fade p-4 {{ !$isRegisterError ? 'show active' : '' }}" id="login-pane" role="tabpanel"
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-4 mb-3"> {{-- Thêm mb-3 --}}
                            ...
                            <input id="login_password" class="form-control mt-1" type="password" name="password" required
                ...
                <div class="tab-pane fade p-4 {{ $isRegisterError ? 'show active' : '' }}" id="register-pane"
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="register_email" type="email" name="email" class="form-control"
