...
<div class="container mt-5 d-flex justify-content-center">
    <div class="w-100" style="max-width:650px; border:1px solid #dee2e6; box-shadow:0 8px 16px rgba(0,0,0,0.1); border-radius:8px; padding:30px; background-color:#fff;">
        
        <div class="text-center mb-4">
            <!-- Tick xanh lớn -->
            <div class="mx-auto mb-4" style="width:100px; height:100px; border-radius:50%; background-color:#28a745; display:flex; align-items:center; justify-content:center; box-shadow:0 4px 8px rgba(0,0,0,0.1);">
        ...
        <div class="card p-4" style="border:none; box-shadow:none;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4"><strong>Phương thức thanh toán:</strong> {{ $order->payment_method }}</div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6"><strong>Trạng thái đơn hàng:</strong> {{ $order->status_text }}</div>
                <div class="col-md-6"><strong>Trạng thái thanh toán:</strong> {{ $order->payment_status }}</div>
            </div>
            ...
            <div class="text-end mb-3">
                <h4 class="text-success fw-bold">Tổng tiền: {{ number_format($order->total_price,0,',','.') }}₫</h4>
            </div>
